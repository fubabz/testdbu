...
public class ApplicationDBTest {
    private static final Logger logger = LoggerFactory.getLogger(ApplicationDBTest.class);
    ...
    public void setUp() throws ClassNotFoundException, SQLException, DatabaseUnitException,
            IOException {
        connection = DBConnection.from(DBConfig.fromProperty("/serverapplication.properties", this.getClass()));
    }
    ...
    @Test
    public void testSave() throws DataSetException, FileNotFoundException, IOException{
        QueryDataSet ds = new QueryDataSet(connection);
        ds.addTable("inter_basic");
        XlsDataSet.write(ds, new FileOutputStream("ap.xls"));
        FlatXmlDataSet.write(ds, new FileOutputStream("ap.xml"));
    }
//    
//    @Test
